...
config.model.max_epochs_candidate = 10;
...
% ------------------
% Allow quick testing with a local mrdamper.mat placed in v0.2/mldamper
...
while numel(W_hidden) < config.model.max_hidden_units
    ...
    config.model.eta_output = config.model.eta_output / 4;
