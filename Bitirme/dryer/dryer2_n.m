...
config.model.output_trainer = 'N_Step_Trajectory';
...
% Mevcut config altına ekle:
config.model.trajectory_steps = 3; % Hocanın örneğindeki N=20 (neuralOdeTimesteps)
config.model.trajectory_batch_size = 64; % Hocanın mbs dediği
...
batch_size = config.model.trajectory_batch_size;
...
all_params.trajectory_steps = trajectory_steps;
